function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            ...
            _pStartPosAudio = {x:CANVAS_WIDTH - (oSprite.width/2),y:(oSprite.height/2) + 2};
            ...
            _pStartPosFullscreen = {x:CANVAS_WIDTH - (oSprite.width/2),y:(oSprite.height/2) + 2};
        }
    ...
    this.refreshButtonPos = function(iNewX,iNewY){
        // _oButExit.setPosition(CANVAS_WIDTH - (oSprite.width/2) - 2 - iNewX,iNewY + _pStartPosExit.y);
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){

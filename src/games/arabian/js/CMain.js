function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'game_over_bonus',loop:false,volume:1, ingamename: 'game_over_bonus'});
        s_aSoundsInfo.push({path: './sounds/',filename:'reel_bonus',loop:false,volume:1, ingamename: 'reel_bonus'});
        s_aSoundsInfo.push({path: './sounds/',filename:'start_reel_bonus',loop:false,volume:1, ingamename: 'start_reel_bonus'});
        s_aSoundsInfo.push({path: './sounds/',filename:'win_bonus',loop:false,volume:1, ingamename: 'win_bonus'});

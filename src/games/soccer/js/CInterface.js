function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            _pStartPosAudio = {x:CANVAS_WIDTH - (oSprite.width/2) - 2,y:(oSprite.height/2) + 2};
            ...
            _pStartPosFullscreen = {x:CANVAS_WIDTH - (oSprite.width/2) - 2,y:(oSprite.height/2) + 2};
        }
        ...
        _oInfoBut = new CTextButton(272 + (oSprite.width/2),595,oSprite,TEXT_INFO,FONT_GAME,"#ffffff",30);        
	...
	_oMoneyText = new createjs.Text(TEXT_MONEY +"\n"+iMoney.toFixed(2)+TEXT_CURRENCY,"24px "+FONT_GAME, "#ffde00");
        ...
        _oNumLinesText.y = CANVAS_HEIGHT - 86;
        ...
        _oTotalBetText.y = CANVAS_HEIGHT - 86;

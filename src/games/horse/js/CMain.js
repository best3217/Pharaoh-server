function CMain(oData) {
    ...
    this._loadImages = function () {
        ...
        for(var i=0;i<NUM_HORSES;i++){
            ...
            s_oSpriteLibrary.addSprite("horse_"+(i+1)+"_a", "./sprites/horse_"+(i+1)+"_a.png");
            s_oSpriteLibrary.addSprite("horse_"+(i+1)+"_b", "./sprites/horse_"+(i+1)+"_b.png");
            s_oSpriteLibrary.addSprite("cage_"+i, "./sprites/cage_"+i+".png");
            s_oSpriteLibrary.addSprite("gate_"+i, "./sprites/cage_gates/gate_"+i+".png");
        }
